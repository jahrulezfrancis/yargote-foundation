...
import DownloadButton from "@/utils/downloadProgramButton"
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      <main>
        ...
        <section className="relative bg-gradient-to-br from-gray-50 to-white py-12 md:py-16 overflow-hidden transition-all duration-700 ease-out">
          {/* Animated background elements */}
          <div className={`absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-emerald-50/40 to-transparent rounded-full transition-all duration-[2000ms] ease-out ${isVisible ? '-translate-y-1/3 translate-x-1/3' : 'translate-y-full translate-x-full'
            }`} />
          <div className={`absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr from-emerald-50/30 to-transparent rounded-full transition-all duration-[2000ms] ease-out delay-300 ${isVisible ? 'translate-y-1/3 -translate-x-1/3' : 'translate-y-full -translate-x-full'
            }`} />

          {/* Floating accent elements */}
          <div className={`absolute top-1/4 right-1/4 w-2 h-2 bg-emerald-200 rounded-full animate-pulse transition-all duration-1000 ease-out delay-500 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-0'
            }`} />
          <div className={`absolute bottom-1/3 left-1/5 w-1.5 h-1.5 bg-emerald-200 rounded-full animate-pulse transition-all duration-1000 ease-out delay-700 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-0'
            }`} />

          <div className="container mx-auto px-6 md:px-8 relative z-10 transition-all duration-700 ease-out">
              ...
              <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 items-center">
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className={`flex flex-wrap items-center gap-4 pt-2 transition-all duration-700 ease-out delay-800 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                    ...
                    <button onClick={() => scrollToSection("programs-section")} className="px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl transform active:scale-95">
                      Explore Programs
                    </button>
                    <DownloadButton />
                  </div>
                      ...
                      <div className="pt-4 border-t border-gray-100">
                        ...
                        <div className="flex items-center gap-3">
                          <div className="flex-1 h-2 bg-gray-100 rounded-full overflow-hidden">
                            <div className={`h-full bg-gradient-to-r from-green-500 to-emerald-600 rounded-full transition-all duration-[1500ms] ease-out delay-1000 ${isVisible ? 'w-[92%]' : 'w-0'
                              }`}></div>
                          </div>
        ...
        <section ref={featuredRef} id="featured-section" className="py-24 bg-white relative overflow-hidden transition-all duration-700 ease-out">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-20 transition-all duration-700 ease-out">
              ...
              {programs[0].components?.map((component, index) => (
                ...
                >
                  <CardContent className="space-y-6">
                    <div className="w-16 h-16 bg-gray-50 group-hover:bg-emerald-600 rounded-2xl flex items-center justify-center mx-auto transition-all duration-500 group-hover:rotate-12 transform">
        ...
        {/* Program Overview */}
        <section ref={overviewRef} id="overview-section" className="py-24 bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden transition-all duration-700 ease-out programs-section">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-16">
              {programComponents.map((component, index) => (
                <Card key={index} className={`text-center p-8 border-gray-200 bg-white hover:shadow-xl transition-all duration-700 hover:-translate-y-2 group hover:bg-gradient-to-br hover:from-white hover:to-emerald-50 ${isSectionVisible('overview-section') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
                  }`}
        ...
        {/* All Programs Grid */}
        <section ref={allProgramsRef} id="all-programs-section" className="py-24 bg-white overflow-hidden transition-all duration-700 ease-out">
          <div className="container mx-auto px-4">
        ...
        <section ref={ctaRef} id="cta-section" className="py-24 bg-gray-900 text-white relative overflow-hidden transition-all duration-700 ease-out">
          ...
          <div className="container mx-auto px-4 text-center space-y-8 relative z-10 transition-all duration-700 ease-out">
